                                ...
                                <div className='flex flex-wrap justify-between items-center w-full '>
                                    <div className="flex flex-col w-[30%] border-2 border-[#E6E6E2] rounded-md p-5 h-55">
                                        <div className="text-center flex flex-col items-center justify-around h-full">
                                            ...
                                            <h2 className="text-base lg:text-2xl font-bold">16/20</h2>
                                        </div>
                                    </div>
                                    <div className="flex flex-col w-[30%] border-2 border-[#E6E6E2] rounded-md p-5 h-55">
                                        <div className="text-center flex flex-col items-center justify-around h-full">
                                            ...
                                            <p className="text-base lg:text font-medium">Horas treinadas por semana</p>
                                            <h2 className="text-base lg:text-2xl font-bold">10h 30min</h2>
                                        </div>
                                    </div>
                                    <div className="flex flex-col w-[30%] border-2 border-[#E6E6E2] rounded-md p-5 h-55">
                                        <div className="text-center flex flex-col items-center justify-around h-full">
                                            ...
                                            <h2 className="text-base lg:text-2xl font-bold">69%</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
