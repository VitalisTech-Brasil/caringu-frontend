...
import MenuLateral from "../../components/Aluno/MenuLateral/MenuLateral";
import CompromissosAgenda from "../../components/Aluno/CompromissosAgenda";
        ...
        <div className="flex min-h-screen bg-[var(--cor-secundaria)]">
            ...
            <div className="flex-1 overflow-y-auto">
                ...
                <div className="w-full h-auto flex lg:flex-row flex-col">
                    <div className=" w-full pt-10 lg:hidden flex flex-row items-center justify-center text-xl h-auto font-semibold">
                        <span>Acompanhe suas aulas agendadas</span>
                    </div>
                    <div className="pl-[1rem] sm:pt-12 pb-2 w-full lg:w-[50%] h-auto flex flex-col items-start justify-start">
                        <div className="w-[80%] pt-2 hidden lg:flex flex-row items-center justify-center text-xl h-auto font-semibold">
                            <span>Acompanhe suas aulas agendadas</span>
                        </div>
                        <Calendario
                            value={value}
                        ...
                        />
                        <div className=" w-full h-auto flex flex-col items-start justify-start gap-4 mt-1 pb-2">
                    ...
                    <div className="w-[96%] lg:w-[48%] h-auto max-h-200 flex flex-col pt-2 lg:pt-12 pl-[1rem] sm:pl-[3.5rem] lg:pl-0">
                        <div className="my-4 border-solid border-[#1D2D441C] border-4 rounded-md w-full h-auto p-4 flex flex-col lg:mb-0">
                            <CompromissosAgenda
                                compromissos={compromissos}
                                selectedDay={selectedDay}
                                OrigemDeUso={"agendaAluno"}
