        ...
        if (!idAluno || !personalIdSelecionado) {
            toast.custom(t =>
                <CustomToast
                    t={t}
                    type="error"
                    message="IDs do aluno ou personal não encontrados."
                />
            );
            return;
        }
        ...
        if (!rating || rating < 1) {
            toast.custom(t =>
                <CustomToast
                    t={t}
                    type="error"
                    message="Por favor, selecione uma nota entre 1 e 5 antes de enviar."
                />
            );
            return;
        }
            ...
            {showModalAvaliar && (
                <div className="fixed inset-0 z-[49] flex justify-center items-center overflow-y-auto">
                    ...
                    <div className="relative p-4 w-full max-w-2xl">
                        <div className="relative p-4 bg-[var(--cor-secundaria)] rounded-lg shadow sm:p-10">
                            <div className="flex justify-between items-center pb-4 mb-4">
                                ...
                                <button
                                    ...
                                    className="bg-[#B41F1F] text-white rounded-lg w-10 h-10 inline-flex justify-center items-center absolute top-2 right-2"
                                >
                                    ✕
                                </button>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="flex p-4">
                                    <textarea
                                        placeholder="Compartilhe o que achou do serviço do personal"
                                        className="h-30 bg-[#D9D9D945] w-full p-2 rounded"
                                        value={comentario}
                    ...
                    <div className="relative p-4 w-full max-w-2xl">
                        <div className="relative p-4 bg-[var(--cor-secundaria)] rounded-lg shadow sm:p-10">
                            <div className="flex flex-col justify-center items-center text-center">
                                <svg className="w-20 mb-4" viewBox="0 0 114 114" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h1 className="text-xl font-semibold text-[var(--cor-primaria)] mb-2">Agradecemos seu comentário!</h1>
                                <span className="w-[55%] mb-6">Em breve sua avaliação será apresentada no perfil do personal.</span>
                                <Button
                                    texto="Fechar"
                                    cor="#748CAB"
                                    corTexto="#FFFFFF"
