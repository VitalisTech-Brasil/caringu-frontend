...
const MinhaEvolucao = () => {
    ...
    const handleFetchTreinos = async () => {
        try {
            const response = await caringuApi.get(
                `/treinos-exercicios/relatorio-treino/aluno/${idAluno}?page=${currentPage - 1}&size=${pageSize}`
            );
    ...
    const filteredTreinos = searchTerm
        ? treinos.filter(t =>
            t.nomeTreino.toLowerCase().includes(searchTerm.toLowerCase())
        )
        : treinos;
    ...
    return (
        <div className="flex min-h-screen bg-[var(--cor-secundaria)]">
            ...
            <div className="flex-1 overflow-y-auto">
                ...
                />
                <div className="pl-[1rem] sm:pl-[3.5rem] w-[90%] h-auto flex mt-6 flex-col gap-3">
                    <div>
                ...
                <div className="flex flex-col w-full h-180 overflow-y-auto justify-between pb-2">
                    <div className="w-full h-auto flex flex-col md:flex-row md:flex-wrap">
                        {currentTreinos.length === 0 ? (
                            ...
                            currentTreinos.map((treino) => (
                                <div key={treino.idTreino} className="w-[90%] md:w-[45%] lg:w-[30%] mx-auto my-2 p-4 border border-gray-300 rounded-lg flex flex-col gap-2">
