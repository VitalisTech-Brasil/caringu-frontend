...
const DashboardAluno = () => {
    ...
    useEffect(() => {
        document.title = "Dashboard | CaringU";
        ...
        <div className="flex min-h-screen bg-[var(--cor-secundaria)]">
            ...
            <div className="flex-1 overflow-y-auto">
                <Header
                    ...
                    title='Relatórios'
                    icon={
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 45 45" fill="none">
                ...
                />
                <main className="p-4 md:p-8 space-y-8 flex flex-col items-center    ">
                    <div className="bg-[var(--cor-secundaria)] rounded-lg p-4  border-2 border-[#E6E6E2] flex  flex-col w-full lg:w-[60%] gap-3">
