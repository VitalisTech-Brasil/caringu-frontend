            ...
            <div className="flex-1 flex flex-col">
                ...
                <main className="p-4 md:p-8 font-sans space-y-8 flex flex-col">
                    <div className="bg-[var(--cor-secundaria)] rounded-lg p-4 md:p-6 border border-[#E6E6E2]">
                        <h1 className="text-zinc-900 text-xl md:text-3xl font-semibold font-['Inter']">Gerenciamento de Treinos</h1>
                        <div className="flex flex-col md:flex-row items-center gap-2 mb-4 mt-5 justify-between max-w-full">
                            <div className="flex items-center gap-2 md:w-full">
                                <input
                                    type="text"
                                    placeholder="Pesquisar treino"
                                    className="flex-1 border border-gray-300 rounded-md p-2 md:max-w-1/2"
                                    value={searchTerm}
                                ...
                                <Popover
                                    ...
                                    content={
                                        <div className="p-4 space-y-4">
                                            ...
                                            <div className="flex gap-2">
                                                <Button
                                                    color={difficultyFilter === "Iniciante" ? "blue" : "gray"}
                                                    onClick={() =>
                                                        setDifficultyFilter((prev) => (prev === "Iniciante" ? null : "Iniciante"))
                                                    }
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-7" viewBox="0 0 32 31" fill="none">
                                                        <path d="M6.72852 2.58301V28.4163" stroke="#748CAB" strokeWidth="2.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                                        <path d="M6.72852 5.16699H21.2581C24.7607 5.16699 25.5391 7.10449 23.0743 9.55866L21.5175 11.1087C20.4797 12.142 20.4797 13.8212 21.5175 14.7253L23.0743 16.2753C25.5391 18.7295 24.631 20.667 21.2581 20.667H6.72852" stroke="#748CAB" strokeWidth="2.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                                    </svg>
                                                    Dificuldade: Iniciante
                                                </Button>
                                                <Button
                                                    color={difficultyFilter === "Intermediário" ? "blue" : "gray"}
                                                    onClick={() =>
                                                        setDifficultyFilter((prev) => (prev === "Intermediário" ? null : "Intermediário"))
                                                    }
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-7" viewBox="0 0 32 31" fill="none">
                                                        <path d="M6.72852 2.58301V28.4163" stroke="#E8CD00" strokeWidth="2.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                                        <path d="M6.72852 5.16699H21.2581C24.7607 5.16699 25.5391 7.10449 23.0743 9.55866L21.5175 11.1087C20.4797 12.142 20.4797 13.8212 21.5175 14.7253L23.0743 16.2753C25.5391 18.7295 24.631 20.667 21.2581 20.667H6.72852" stroke="#E8CD00" strokeWidth="2.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                                    </svg>
                                                    Dificuldade: Intermediario
                                                </Button>
                                                <Button
                                                    color={difficultyFilter === "Avançado" ? "blue" : "gray"}
                                                    onClick={() =>
                                                        setDifficultyFilter((prev) => (prev === "Avançado" ? null : "Avançado"))
                                                    }
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-7" viewBox="0 0 32 31" fill="none">
                                                        <path d="M6.72852 2.58301V28.4163" stroke="#B41F1F" strokeWidth="2.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                                        <path d="M6.72852 5.16699H21.2581C24.7607 5.16699 25.5391 7.10449 23.0743 9.55866L21.5175 11.1087C20.4797 12.142 20.4797 13.8212 21.5175 14.7253L23.0743 16.2753C25.5391 18.7295 24.631 20.667 21.2581 20.667H6.72852" stroke="#B41F1F" strokeWidth="2.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                                    </svg>
                                                    Dificuldade: Avançado
                                                </Button>
                                            </div>
                                            <div className="flex gap-2">
                                                <Button
                                                    color={showOnlyFavorites ? "blue" : "gray"}
                                                    onClick={() => setShowOnlyFavorites((prev) => !prev)}
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-7" viewBox="0 0 35 35" fill="none">
                                                        <path d="M20.0227 5.11836L22.5893 10.2517C22.9393 10.9663 23.8727 11.6517 24.6602 11.7829L29.3122 12.5559C32.2872 13.0517 32.9872 15.21 30.8435 17.3392L27.2268 20.9559C26.6143 21.5684 26.2789 22.7496 26.4685 23.5954L27.5039 28.0725C28.3206 31.6163 26.4393 32.9871 23.3039 31.135L18.9435 28.5538C18.156 28.0871 16.8581 28.0871 16.056 28.5538L11.6956 31.135C8.57474 32.9871 6.67891 31.6017 7.49558 28.0725L8.53099 23.5954C8.72058 22.7496 8.38516 21.5684 7.77266 20.9559L4.156 17.3392C2.02683 15.21 2.71225 13.0517 5.68725 12.5559L10.3393 11.7829C11.1122 11.6517 12.0456 10.9663 12.3956 10.2517L14.9622 5.11836C16.3622 2.33294 18.6372 2.33294 20.0227 5.11836Z" stroke="#E96E35" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                                    </svg>
                                                    Favoritos
                                                </Button>
                                            </div>
                        ...
                        <div className="flex flex-col items-center gap-4 mt-5 bg-[var(--cor-secundaria)] p-4 rounded-lg max-h-140 overflow-y-auto overflow-x-hidden">
                            {filteredTreinos.map((treino) => (
                                <div key={treino.id} className="w-full bg-[var(--cor-secundaria)] border border-[#E6E6E2] flex flex-wrap items-center rounded-lg justify-between p-4">
                                    <div className="flex md:flex-row items-center justify-between md:gap-8 w-full h-full pl-5 pr-5">
                                        <div className="flex flex-col md:flex-row gap-5 md:gap-10 items-center md:items-start justify-start w-full">
                                            <div className="flex items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" className="w-20 h-20 md:w-15 md:h-15" viewBox="0 0 60 49" fill="none">
                                            ...
                                            <div className="flex flex-col md:flex-row md:grid-cols-1 md:gap-10 w-full">
                                                <div>
                                        ...
                                        <div className="flex flex-col-reverse justify-end min-h-full md:flex-row md:gap-10 gap-10">
                                            <ButtonInterno
                                                logoSvg={
                                                    treino.favorito ? (
