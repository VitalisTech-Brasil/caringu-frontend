...
export default function HomePage() {
  return (
    <>
      <header className="absolute top-0 left-0 z-11 w-full h-[80px] flex items-center justify-between text-white px-8">
        <div className="m-4 flex justify-center items-center bg-[#15171B] h-16 w-[400px]">
        ...
        <div className="flex gap-16 items-center w-[400px] justify-end">
