...
const ColunaImagem = () => {
  return (
    <>
        ...
        <section className="bg-[url('../assets/images/imagem-login.svg')] h-95/100 w-[33%] min-w-[250px] rounded-[1%] relative left-[20px] bg-cover bg-center bg-no-repeat max-[800px]:hidden">
          <Link to="/">
