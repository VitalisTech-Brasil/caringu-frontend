...
import logo from "../../assets/logos/caringu-logo-branco-fundo-laranja.svg";
    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed top-4 left-4 z-50 bg-white p-2 rounded shadow-lg"
        >
          <FaBars size={24} />
        </button>
      )}
        ...
        <div className="fixed top-0 left-0 w-64 h-full bg-white shadow-lg z-50 p-4 overflow-y-auto">
          ...
          <div className="mb-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">{nomePessoa}</span>
            </div>
            <div className="text-sm text-gray-500">{tipoPessoa}</div>
          </div>
