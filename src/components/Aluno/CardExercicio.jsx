    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between items-center">
                ...
                >
                    {expandido === exercicio.idExecucaoExercicio ? (
            ...
            <div className="flex gap-5 ml-2">
                <span className="flex items-center gap-2">
                    ...
                    <div className="text-[10px] sm:text-[20px]">
                        <b className="text-[10px] sm:text-[20px]">Carga: </b>{exercicio.carga}
                    </div>
                </span>
                ...
                <span className="flex items-center gap-2">
                    ...
                    <div className="text-[10px] sm:text-[20px]">
                        <b className="text-[10px] sm:text-[20px]">Repetições: </b>{exercicio.repeticoesSeries}
                    </div>
                </span>
            </div>
                ...
                <>
                    ...
                    <div className="ml-2">
                        <span className="flex items-center gap-2">
                            ...
                            <div className="text-[10px] sm:text-[20px]">
                                <b className="text-[10px] sm:text-[20px]">Grupo muscular: </b>{exercicio.grupoMuscular}
                            </div>
                        </span>
                    </div>
                    ...
                    <div className="ml-2">
                        <span className="flex items-center gap-2">
                            ...
                            <div className="text-[10px] sm:text-[20px]">
                                <b className="text-[10px] sm:text-[20px]">Observações: </b>{exercicio.observacoes ? exercicio.observacoes : "Sem Observações"}
                            </div>
                        </span>
                    </div>
                    ...
                    <div className="ml-2">
                        <span className="flex items-center gap-2">
                            ...
                            <div className="text-[10px] sm:text-[20px]">
                                <b className="text-[10px] sm:text-[20px]">Tempo de Descanso: </b>{exercicio.descanso ? exercicio.descanso : "Sem Tempo de Descanso"}
                            </div>
                        </span>
                    </div>
                    ...
                    <div className="ml-2">
                        ...
                        <div>
                            <div className="relative h-40 mt-2 rounded-xl flex justify-center items-center bg-[#fff]">
                                {(() => {
                                    const urlVideoExecucao = exercicio.urlVideoExecucao;
                                    const videoId = extrairYoutubeId(urlVideoExecucao);
                                    const isYoutube = urlVideoExecucao?.includes('youtube.com') || urlVideoExecucao?.includes('youtu.be');
                                    const isGif = urlVideoExecucao?.toLowerCase().endsWith('.gif');
                                    const isImage = urlVideoExecucao && urlVideoExecucao.match(/\.(jpeg|jpg|png|gif)$/i);

                                    if (!urlVideoExecucao) {
                                        return (
                                            <div className="border-2 border-[#15171B3D] h-40 flex justify-center items-center rounded-xl">
                                                ...
                                                {!isPlaying ? (
                                                    ...
                                                    >
                                                        <img
                                                            ...
                                                            loading="lazy"
                                                        />
                                                        <div className="absolute inset-0 bg-black/40 group-hover:bg-black/30 transition-colors rounded-xl" />
                                                        <div className="absolute inset-0 flex items-center justify-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 51 51" fill="none"
                                                                className="drop-shadow-md transition-transform group-active:scale-95 w-8 h-8">
                                    ...
                                    if (isGif || isImage) {
                                        return (
                                            <img
                                                ...
                                                alt={`Exemplo de execução: ${exercicio.nomeExercicio}`}
                                    ...
                                    return (
                                        <video src={urlVideoExecucao} controls className="h-40 w-full rounded-xl" />
                                    );
                                })()}
                            </div>
                        </div>
