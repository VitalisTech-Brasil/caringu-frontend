  ...
  return (
    rule === "aluno" ? (
      <>
        ...
        <Navbar fluid className="navbar relative h-[4.8rem] z-10 bg-white border-b dark:border-gray-300 flex items-center justify-center">
