  ...
  return (
    <>
      <div className={`w-full flex flex-col justify-start items-center relative ${ativo ? '' : 'opacity-50 pointer-events-none'}`}>
        {/* Overlay opcional para reforçar visual de inativo */}
        {!ativo && <div className="absolute inset-0 bg-white opacity-40 rounded-md z-10"></div>}

        {/* Card principal */}
        <div className="relative z-20 w-full sm:w-[450px] 2xl:w-[560px] h-auto rounded-t-md border-t-[2px] border-r-[2px] border-l-[2px] border-[#1D2D441C] sm:p-4 sm:pl-10 p-6 flex flex-col justify-center">
          <div className="h-auto flex flex-row items-end justify-between">
            <h5 className="break-all text-3xl sm:text-[32px] font-medium text-[var(--cor-primaria)] 2xl:w-[56%]">
              {nome}
            </h5>
            <div className="h-full flex flex-row justify-end w-[12rem] gap-[0.3rem]">
              <div className="h-full flex items-center flex-col w-[50%]">
                <span
                  className={`font-light text-sm sm:text-md h-[2.75rem] pl-2 pr-2 sm:pl-6 sm:pr-6 w-[100%] rounded-[15px] flex flex-row items-center justify-center
              ${periodo === "MENSAL"
                ...
                {ativo && (
                  <span className="text-[var(--cor-primaria)] text-xs sm:text-sm mt-1 flex items-center gap-1 justify-center">
          ...
          <div className="mt-3 sm:mt-0 flex items-baseline w-full gap-3">
            <span
              className={`text-lg sm:text-2xl 2xl:text-[32px] font-extrabold
          ${periodo === "MENSAL"
                  ? "text-[var(--azul-claro)]"
                  : periodo === "AVULSO"
            ...
            <span className="text-lg sm:text-2xl 2xl:text-[32px] font-extrabold text-[var(--cor-primaria)]">{valorPlano}</span>
          </div>
          ...
          <div className="flex sm:flex-row flex-col justify-between">
            <ul role="list" className="space-y-7 my-4">
              ...
              <li className="flex items-center">
                ...
                <span className="text-base sm:text-xl 2xl:text-2xl font-light text-[var(--cor-primaria)] leading-tight ms-6">
        ...
        <div className="border-[2px] border-[#1D2D441C] h-auto flex flex-col w-full sm:w-[450px] 2xl:w-[560px] p-6 gap-3">
          <span className="text-sm sm:text-lg 2xl:text-xl font-light text-[var(--cor-primaria)] leading-tight flex items-center gap-2">
            ...
            <span className="text-md sm:text-lg 2xl:text-[16px] font-extrabold">Personal:</span>
            Mônica Luiz Borges Moreno
          </span>
          <span className="text-sm sm:text-lg 2xl:text-xl font-light text-[var(--cor-primaria)] leading-tight flex items-center gap-2">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M18.3333 10.0003C18.3333 14.6003 14.6 18.3337 9.99996 18.3337C5.39996 18.3337 1.66663 14.6003 1.66663 10.0003C1.66663 5.40033 5.39996 1.66699 9.99996 1.66699C14.6 1.66699 18.3333 5.40033 18.3333 10.0003Z" stroke="#1D2D44" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M13.0917 12.6505L10.5083 11.1088C10.0583 10.8421 9.69165 10.2005 9.69165 9.67546V6.25879" stroke="#1D2D44" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            2 anos de experiência
          </span>
          <span className="text-sm sm:text-lg 2xl:text-xl font-light text-[var(--cor-primaria)] leading-tight flex items-center gap-2">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M14.1666 17.0837H5.83329C3.33329 17.0837 1.66663 15.8337 1.66663 12.917V7.08366C1.66663 4.16699 3.33329 2.91699 5.83329 2.91699H14.1666C16.6666 2.91699 18.3333 4.16699 18.3333 7.08366V12.917C18.3333 15.8337 16.6666 17.0837 14.1666 17.0837Z" stroke="#1D2D44" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M14.1667 7.5L11.5584 9.58333C10.7 10.2667 9.2917 10.2667 8.43337 9.58333L5.83337 7.5" stroke="#1D2D44" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            monica_ef2012@gmail.com
          </span>
          <span className="text-sm sm:text-lg 2xl:text-xl font-light text-[var(--cor-primaria)] leading-tight flex items-center gap-2">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3.01773 7.07533C4.65939 -0.141339 15.3511 -0.133006 16.9844 7.08366C17.9427 11.317 15.3094 14.9003 13.0011 17.117C11.3261 18.7337 8.67606 18.7337 6.99273 17.117C4.69273 14.9003 2.05939 11.3087 3.01773 7.07533Z" fill="#FDFCFA" stroke="#1D2D44" stroke-width="2" />
              <path d="M10.0004 11.1912C11.4363 11.1912 12.6004 10.0272 12.6004 8.59121C12.6004 7.15527 11.4363 5.99121 10.0004 5.99121C8.56445 5.99121 7.40039 7.15527 7.40039 8.59121C7.40039 10.0272 8.56445 11.1912 10.0004 11.1912Z" stroke="#1D2D44" stroke-width="2" />
            </svg>
            São Paulo, SP
          </span>
          <Button
