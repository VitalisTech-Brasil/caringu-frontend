                    ...
                    <div className="h-auto  flex flex-row items-end justify-between">
                        ...
                        <div className="h-full flex flex-row justify-end w-[12rem] gap-[0.3rem]">
                            <div className="h-full flex items-center flex-col w-[50%]">
                                <span className={`font-light text-sm sm:text-md h-[2.75rem] pl-2 pr-2 sm:pl-6 sm:pr-6 w-[100%] rounded-[15px] flex flex-row items-center justify-center
                                        ${periodo === "MENSAL"
