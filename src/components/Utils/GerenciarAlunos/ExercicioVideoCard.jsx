        ...
        <div className="border-2 border-gray-300 rounded p-4 flex flex-col w-full h-auto gap-6">
            ...
            >
                <div className="flex flex-col h-auto w-[90%] justify-start gap-1">
                    <div className="w-auto h-auto text-[var(--laranja)] text-base lg:text-xl font-bold">
                        <span className="break-words whitespace-normal">{titulo}</span>
                    </div>
                    <div className="sm:mt-0 mt-4 flex flex-col lg:flex-row lg:flex-wrap items-start w-full justify-start sm:gap-2 gap-4 xl:gap-4 text-base">
                        <div className="flex flex-col sm:flex-row items-center h-auto sm:w-auto w-full gap-2 flex-shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14" fill="none" viewBox="0 0 16 14">
                                <path d="M12.3028 3.65649H13.2404C13.4991 3.65649 13.7092 3.90613 13.7092 4.21373V9.78605C13.7092 10.0936 13.4991 10.3433 13.2404 10.3433H12.3028C12.044 10.3433 11.834 10.0936 11.834 9.78605V4.21373C11.834 3.90613 12.044 3.65649 12.3028 3.65649Z" stroke="#1D2D44" />
                                <path d="M10.4278 1.42749H11.3654C11.6241 1.42749 11.8342 1.67713 11.8342 1.98472V12.0149C11.8342 12.3225 11.6241 12.5721 11.3654 12.5721H10.4278C10.169 12.5721 9.95898 12.3225 9.95898 12.0149V1.98472C9.95898 1.67713 10.169 1.42749 10.4278 1.42749Z" stroke="#1D2D44" />
                                <path d="M3.86528 1.42749H4.80286C5.06163 1.42749 5.27165 1.67713 5.27165 1.98472V12.0149C5.27165 12.3225 5.06163 12.5721 4.80286 12.5721H3.86528C3.6065 12.5721 3.39648 12.3225 3.39648 12.0149V1.98472C3.39648 1.67713 3.6065 1.42749 3.86528 1.42749Z" stroke="#1D2D44" />
                                <path d="M1.98832 3.65649H2.92591C3.18468 3.65649 3.3947 3.90613 3.3947 4.21373V9.78605C3.3947 10.0936 3.18468 10.3433 2.92591 10.3433H1.98832C1.72955 10.3433 1.51953 10.0936 1.51953 9.78605V4.21373C1.51953 3.90613 1.72955 3.65649 1.98832 3.65649Z" stroke="#1D2D44" />
                                <path d="M13.709 6.99963H15.1154" stroke="#1D2D44" />
                                <path d="M5.26953 6.99963H9.95745" stroke="#1D2D44" />
                                <path d="M0.113281 6.99963H1.51966" stroke="#1D2D44" />
                            </svg>
                        ...
                        <div className="flex flex-col sm:flex-row items-center h-auto sm:w-auto w-full gap-1 flex-shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="15" fill="none" viewBox="0 0 20 15">
                                <path d="M7.64678 13.75H12.3044C16.1857 13.75 17.7383 12.5 17.7383 9.375V5.625C17.7383 2.5 16.1857 1.25 12.3044 1.25H7.64678C3.76543 1.25 2.21289 2.5 2.21289 5.625V9.375C2.21289 12.5 3.76543 13.75 7.64678 13.75Z" stroke="#1D2D44" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M14.244 7.5C14.244 9.4 12.3344 10.9375 9.97456 10.9375C7.6147 10.9375 6.17859 9.025 6.17859 9.025M6.17859 9.025H8.10375M6.17859 9.025V10.7438M5.70508 7.5C5.70508 5.6 7.59918 4.0625 9.97456 4.0625C12.8235 4.0625 14.244 5.975 14.244 5.975M14.244 5.975V4.25625M14.244 5.975H12.3499" stroke="#1D2D44" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        ...
                        <div className="flex flex-col sm:flex-row flex-wrap items-center gap-1 flex-shrink min-w-0">
                            ...
                            <div className="flex flex-row flex-wrap items-center gap-1 min-w-0">
                                <span className="whitespace-nowrap">Grupo Muscular:</span>
            ...
            {aberto && (
                <div className="flex flex-col h-auto w-full px-1 sm:px-7">
                    ...
                    <div className="flex flex-col h-auto w-full gap-2.5 mt-2">
                        ...
                        <div className="relative lg:w-[80%] xl:w-[65%] md:w-[60%] w-full aspect-video overflow-hidden border-2 border-gray-300 rounded">
                            {!isPlaying && (
                                <button
                                    type="button"
                                    onClick={handlePlay}
