...
const CarrosselRegistro = ({ imagens = [], titulo = "" }) => {
  ...
  return (
    <div className="relative py-12 flex flex-col items-center justify-center gap-2 max-w-[501px] md:max-w-6xl mx-auto">
            ...
            <SwiperSlide key={item.id}>
              <div className="flex flex-col items-center">
                <div
                  ...
                  className="w-40 h-40 md:w-48 md:h-48 bg-gray-300 rounded cursor-pointer flex items-center justify-center"
                >
                  {item.src ? (
                    <img
                      src={item.src}
