...
const CardPlano = ({ onEditar, onDeletar }) => {
  ...
  return (
    <>
      <div className="w-full 2xl:w-[560px]  rounded-md border-[2px] border-[#1D2D441C] sm:p-4 sm:pl-10 p-2 relative">
        <div className="h-[4.25rem]  flex flex-row items-end justify-between">
          <h5 className="text-[40px] font-medium text-[var(--cor-primaria)] ">Plano Basic</h5>
          <div className="h-full flex flex-row justify-end w-[12rem] gap-[0.3rem]">
            <div className="h-full  flex flex-row items-end ">
              <span className="font-light text-2xl bg-[#748CAB36] h-[2.75rem] w-[8.6rem] rounded-[15px] flex flex-row items-center justify-center text-[var(--azul-claro)]">Mensal</span>
            </div>
            {menuOpen && (
              <div className="absolute  mt-10 w-37 h-19 bg-[var(--cor-secundaria)] rounded-md flex flex-col justify-center border-[#1D2D441A] border-solid border-[2px]">
                <div className="py-1 pl-1 pr-1">
                  <div className="flex flex-row items-center w-full hover:bg-[#1D2D4417] h-8 rounded-md cursor-pointer"
                    onClick={handleEdit}>
                    <span
                      className="ml-4 w-[6rem] text-base font-normal text-[var(--cor-primaria)] text-center"
                    >
                      Editar
                    </span>
                  ...
                  <div className="flex w-full hover:bg-[#1D2D4417] flex-row items-center h-8 rounded-md cursor-pointer"
                    ...
                    <button
                      className="ml-4 w-[6rem] text-base font-normal text-[var(--cor-primaria)]"
                    >
                      Deletar
                    </button>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className="mr-2">
        ...
        <div className="flex items-baseline w-full gap-3">
          <span className="text-[32px] font-extrabold text-[var(--azul-claro)]">R$</span>
          <span className="text-[32px] font-extrabold text-[var(--cor-primaria)]">500,00</span>
        </div>
        <ul role="list" className="space-y-7 my-4">
          <li className="flex items-center">
            ...
            <span className="text-2xl font-light text-[var(--cor-primaria)] leading-tight ms-6">60 min por aula</span>
          </li>
          <li className="flex">
            ...
            <span className="text-2xl font-light text-[var(--cor-primaria)] leading-tight  ms-6">5 aulas por mês </span>
          </li>
          <li className="flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none">
            ...
            <span className="text-2xl font-semibold text-[var(--cor-primaria)] leading-tight ms-6">R$100</span>
            <span className="text-2xl font-light text-[var(--cor-primaria)] leading-tight ms-2">por aula</span>
          </li>
        </ul>
      </div>
    </>
