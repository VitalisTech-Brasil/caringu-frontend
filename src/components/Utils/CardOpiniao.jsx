...
const CardOpiniao = () => {
    ...
    const StarFull = () => (
        <svg className="mx-1.5 h-9 w-9" xmlns="http://www.w3.org/2000/svg"  width="36" height="36" viewBox="0 0 36 36" fill="none">
    ...
    return (
        <>
            <div className="w-[89%] h-[19rem] rounded-md border-[2px] border-[#1D2D441C] border-solid flex flex-col items-start p-4 pr-[2rem]">
                <div className="flex flex-row items-center justify-between w-full h-auto">
                    <div className="flex flex-row items-center gap-6">
                        <img src="https://res.cloudinary.com/lptennis/image/upload/v1665352930/zllaquu1qwwi2jx1scif.jpg" alt="Foto do Aluno" className="rounded-full h-[45px] w-[45px] md:h-[92px] md:w-[92px]" />
                        <div className="flex flex-col items-start justify-start gap-1.5">
                            <span className="text-[var(--cor-primaria)] font-semibold text-base sm:text-xl lg:text-xs 2xl:text-xl">Maria Gladys Mello da Silva</span>
                ...
                <div className="flex w-full h-auto  pl-5 pt-6">
                    <p className="text-[var(--cor-primaria)] font-normal text-base sm:text-xl lg:text-xs 2xl:text-xl">
                    Profissional excelente, super educada e atenciosa, muito cuidadosa! Apenas contratem, não vão se arrepender!
                                        </p>
                </div>
            </div>
        </>
