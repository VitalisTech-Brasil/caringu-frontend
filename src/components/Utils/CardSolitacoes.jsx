    ...
    return (
        <>
            <div className="ml-[1.5rem] sm:ml-[2.5rem] h-auto w-[95%] border-solid border-[#1D2D441C] border-[2px] rounded-md">
                <div className="flex flex-col md:flex-row items-start px-4 md:pl-[5rem] gap-4 md:gap-8 mt-4 mb-4">
                    ...
                    <div className="flex flex-row flex-wrap lg:flex-nowrap items-center h-[10vh] justify-start md:justify-end w-full md:w-[30%] gap-2 md:gap-6 ">
